    ...
    <footer className="bg-card border-t border-theme py-12">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-6">
          <a href="https://github.com/eoneres" target="_blank" className="text-secondary hover:text-accent transition"><Github size={20} /></a>
          <a href="https://linkedin.com/in/filipe-neres-fernandes" target="_blank" className="text-secondary hover:text-accent transition"><Linkedin size={20} /></a>
